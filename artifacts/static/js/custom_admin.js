document.addEventListener("DOMContentLoaded", function() {
    ...
    if (sidebar) {
        ...
        // Add class for dark/light border based on theme
        if (sidebar.classList.contains("sidebar-dark-warning") || sidebar.classList.contains("bg-dark") || sidebar.getAttribute("data-bs-theme") === "dark") {
